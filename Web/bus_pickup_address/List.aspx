<%@ Page Title="bus_pickup_address" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_pickup_address.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="pickup_code" HeaderText="pickup_code" SortExpression="pickup_code" ItemStyle-HorizontalAlign="Center"  /> 
