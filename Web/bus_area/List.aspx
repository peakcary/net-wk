<%@ Page Title="bus_area" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_area.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="parent_id" HeaderText="parent_id" SortExpression="parent_id" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="name" HeaderText="name" SortExpression="name" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="area_type" HeaderText="area_type" SortExpression="area_type" ItemStyle-HorizontalAlign="Center"  /> 
