<%@ Page Title="bus_share" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_share.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="link_url" HeaderText="link_url" SortExpression="link_url" ItemStyle-HorizontalAlign="Center"  /> 
