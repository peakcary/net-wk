<%@ Page Title="bus_discount_gift" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_discount_gift.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="gift_id" HeaderText="gift_id" SortExpression="gift_id" ItemStyle-HorizontalAlign="Center"  /> 
