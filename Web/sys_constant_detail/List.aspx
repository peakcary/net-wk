<%@ Page Title="sys_constant_detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.sys_constant_detail.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="constant_id" HeaderText="constant_id" SortExpression="constant_id" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="constant_key" HeaderText="constant_key" SortExpression="constant_key" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="constant_value" HeaderText="constant_value" SortExpression="constant_value" ItemStyle-HorizontalAlign="Center"  /> 
