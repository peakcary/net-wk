<%@ Page Title="bus_dish_size" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_dish_size.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="affect_price" HeaderText="affect_price" SortExpression="affect_price" ItemStyle-HorizontalAlign="Center"  /> 
