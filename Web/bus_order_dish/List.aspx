<%@ Page Title="bus_order_dish" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_order_dish.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="dish_id" HeaderText="dish_id" SortExpression="dish_id" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="total_original_price" HeaderText="total_original_price" SortExpression="total_original_price" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="total_discount_price" HeaderText="total_discount_price" SortExpression="total_discount_price" ItemStyle-HorizontalAlign="Center"  /> 
