<%@ Page Title="bus_payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_payment.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="correlation_code" HeaderText="correlation_code" SortExpression="correlation_code" ItemStyle-HorizontalAlign="Center"  /> 
