<%@ Page Title="bus_deadline" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_deadline.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="deadline_time_type" HeaderText="deadline_time_type" SortExpression="deadline_time_type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="eat_type" HeaderText="eat_type" SortExpression="eat_type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="deadline_days" HeaderText="deadline_days" SortExpression="deadline_days" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="deadline_times" HeaderText="deadline_times" SortExpression="deadline_times" ItemStyle-HorizontalAlign="Center"  /> 
