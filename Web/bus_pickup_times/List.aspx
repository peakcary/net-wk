<%@ Page Title="bus_pickup_times" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_pickup_times.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="pickup_time" HeaderText="pickup_time" SortExpression="pickup_time" ItemStyle-HorizontalAlign="Center"  /> 
