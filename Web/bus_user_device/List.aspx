<%@ Page Title="bus_user_device" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_user_device.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="device_id" HeaderText="device_id" SortExpression="device_id" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="device_type" HeaderText="device_type" SortExpression="device_type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="pushToken" HeaderText="pushToken" SortExpression="pushToken" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="app_version" HeaderText="app_version" SortExpression="app_version" ItemStyle-HorizontalAlign="Center"  /> 
