<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="WK.Web.bus_user_device.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtdevice_id" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		device_type
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtdevice_type" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		pushToken
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtpushToken" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		app_version
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtapp_version" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		is_delete
