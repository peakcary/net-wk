<%@ Page Title="bus_verify_code" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_verify_code.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="verify_type" HeaderText="verify_type" SortExpression="verify_type" ItemStyle-HorizontalAlign="Center"  /> 
