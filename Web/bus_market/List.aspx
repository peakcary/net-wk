<%@ Page Title="bus_market" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_market.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="markket_code" HeaderText="markket_code" SortExpression="markket_code" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="market_type" HeaderText="market_type" SortExpression="market_type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="area_id" HeaderText="area_id" SortExpression="area_id" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="craete_date" HeaderText="craete_date" SortExpression="craete_date" ItemStyle-HorizontalAlign="Center"  /> 
