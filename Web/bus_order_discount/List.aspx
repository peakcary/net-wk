<%@ Page Title="bus_order_discount" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WK.Web.bus_order_discount.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="discount_id" HeaderText="discount_id" SortExpression="discount_id" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="discount_desc" HeaderText="discount_desc" SortExpression="discount_desc" ItemStyle-HorizontalAlign="Center"  /> 
