...
namespace WK.DAL
{
	...
	public partial class bus_order_dish
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_order_dish"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_order_dish");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_order_dish ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_order_dish T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "bus_order_dish";
