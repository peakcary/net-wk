...
namespace WK.DAL
{
	...
	/// 数据访问类:bus_times
	/// </summary>
	public partial class bus_times
	{
		public bus_times()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_times"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_times");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(WK.Model.bus_times model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into bus_times(");
			strSql.Append("start_time,end_time,is_delete,remark,create_by,create_date,update_by,update_date)");
			strSql.Append(" values (");
			strSql.Append("@start_time,@end_time,@is_delete,@remark,@create_by,@create_date,@update_by,@update_date)");
			MySqlParameter[] parameters = {
					new MySqlParameter("@start_time", MySqlDbType.Time),
					new MySqlParameter("@end_time", MySqlDbType.Time),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WK.Model.bus_times model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bus_times set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_times ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_times GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,start_time,end_time,is_delete,remark,create_by,create_date,update_by,update_date from bus_times ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_times DataRowToModel(DataRow row)
		{
			WK.Model.bus_times model=new WK.Model.bus_times();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,start_time,end_time,is_delete,remark,create_by,create_date,update_by,update_date ");
			strSql.Append(" FROM bus_times ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_times T ");
