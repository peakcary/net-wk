...
namespace WK.DAL
{
	...
	public partial class bus_user_black_list
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_user_black_list"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_user_black_list");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(WK.Model.bus_user_black_list model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into bus_user_black_list(");
			strSql.Append("user_type,phone_num,is_delete,remark,create_by,create_date,update_by,update_date)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WK.Model.bus_user_black_list model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bus_user_black_list set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_user_black_list ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_user_black_list GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_type,phone_num,is_delete,remark,create_by,create_date,update_by,update_date from bus_user_black_list ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_user_black_list DataRowToModel(DataRow row)
		{
			WK.Model.bus_user_black_list model=new WK.Model.bus_user_black_list();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_type,phone_num,is_delete,remark,create_by,create_date,update_by,update_date ");
			strSql.Append(" FROM bus_user_black_list ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_user_black_list T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "bus_user_black_list";
