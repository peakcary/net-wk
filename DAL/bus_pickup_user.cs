...
{
	/// <summary>
	/// 数据访问类:bus_pickup_user
	/// </summary>
	public partial class bus_pickup_user
	{
		public bus_pickup_user()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_pickup_user"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_pickup_user");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(WK.Model.bus_pickup_user model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into bus_pickup_user(");
			strSql.Append("pickup_address_id,user_id,is_delete,remark,create_by,create_date,update_by,update_date)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WK.Model.bus_pickup_user model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bus_pickup_user set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_pickup_user ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_pickup_user GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,pickup_address_id,user_id,is_delete,remark,create_by,create_date,update_by,update_date from bus_pickup_user ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
			...
			WK.Model.bus_pickup_user model=new WK.Model.bus_pickup_user();
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_pickup_user DataRowToModel(DataRow row)
		{
			WK.Model.bus_pickup_user model=new WK.Model.bus_pickup_user();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,pickup_address_id,user_id,is_delete,remark,create_by,create_date,update_by,update_date ");
			strSql.Append(" FROM bus_pickup_user ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_pickup_user T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "bus_pickup_user";
