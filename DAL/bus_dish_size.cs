...
namespace WK.DAL
{
	...
	public partial class bus_dish_size
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_dish_size"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_dish_size");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(WK.Model.bus_dish_size model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into bus_dish_size(");
			strSql.Append("name,dish_id,affect_price,is_delete,remark,create_by,create_date,update_by,update_date)");
			strSql.Append(" values (");
			strSql.Append("@name,@dish_id,@affect_price,@is_delete,@remark,@create_by,@create_date,@update_by,@update_date)");
			MySqlParameter[] parameters = {
					new MySqlParameter("@name", MySqlDbType.VarChar,200),
					new MySqlParameter("@dish_id", MySqlDbType.Int32,11),
					new MySqlParameter("@affect_price", MySqlDbType.Decimal,10),
			...
			parameters[2].Value = model.affect_price;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WK.Model.bus_dish_size model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bus_dish_size set ");
			strSql.Append("name=@name,");
			strSql.Append("dish_id=@dish_id,");
			strSql.Append("affect_price=@affect_price,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_dish_size ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_dish_size GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,dish_id,affect_price,is_delete,remark,create_by,create_date,update_by,update_date from bus_dish_size ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_dish_size DataRowToModel(DataRow row)
		{
			WK.Model.bus_dish_size model=new WK.Model.bus_dish_size();
			if (row != null)
			{
				...
				if(row["affect_price"]!=null && row["affect_price"].ToString()!="")
				{
					model.affect_price=decimal.Parse(row["affect_price"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,dish_id,affect_price,is_delete,remark,create_by,create_date,update_by,update_date ");
			strSql.Append(" FROM bus_dish_size ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_dish_size T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "bus_dish_size";
