...
namespace WK.DAL
{
	...
	/// 数据访问类:bus_share
	/// </summary>
	public partial class bus_share
	{
		public bus_share()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_share"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_share");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(WK.Model.bus_share model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into bus_share(");
			strSql.Append("bus_type,title,content,link_url,pic_url,is_delete,remark,create_by,create_date,update_by,update_date)");
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@link_url", MySqlDbType.VarChar,2000),
					new MySqlParameter("@pic_url", MySqlDbType.VarChar,2000),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WK.Model.bus_share model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bus_share set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_share ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_share GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,bus_type,title,content,link_url,pic_url,is_delete,remark,create_by,create_date,update_by,update_date from bus_share ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_share DataRowToModel(DataRow row)
		{
			WK.Model.bus_share model=new WK.Model.bus_share();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,bus_type,title,content,link_url,pic_url,is_delete,remark,create_by,create_date,update_by,update_date ");
			strSql.Append(" FROM bus_share ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_share T ");
