...
{
	/// <summary>
	/// 数据访问类:bus_order_gift
	/// </summary>
	public partial class bus_order_gift
	{
		public bus_order_gift()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_order_gift"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_order_gift");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(WK.Model.bus_order_gift model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into bus_order_gift(");
			strSql.Append("order_id,gift_id,count,is_delete,remark,create_by,create_date,update_by,update_date)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WK.Model.bus_order_gift model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bus_order_gift set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_order_gift ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_order_gift GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,order_id,gift_id,count,is_delete,remark,create_by,create_date,update_by,update_date from bus_order_gift ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_order_gift DataRowToModel(DataRow row)
		{
			WK.Model.bus_order_gift model=new WK.Model.bus_order_gift();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,order_id,gift_id,count,is_delete,remark,create_by,create_date,update_by,update_date ");
			strSql.Append(" FROM bus_order_gift ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_order_gift T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "bus_order_gift";
