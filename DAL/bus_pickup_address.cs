...
namespace WK.DAL
{
	...
	public partial class bus_pickup_address
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "bus_pickup_address"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bus_pickup_address");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(WK.Model.bus_pickup_address model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[0].Value = model.pickup_code;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WK.Model.bus_pickup_address model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bus_pickup_address set ");
			strSql.Append("pickup_code=@pickup_code,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bus_pickup_address ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_pickup_address GetModel(int id)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public WK.Model.bus_pickup_address DataRowToModel(DataRow row)
		{
			WK.Model.bus_pickup_address model=new WK.Model.bus_pickup_address();
			if (row != null)
			{
				...
				if(row["pickup_code"]!=null)
				{
					model.pickup_code=row["pickup_code"].ToString();
				}
				if(row["name"]!=null)
				{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bus_pickup_address T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "bus_pickup_address";
